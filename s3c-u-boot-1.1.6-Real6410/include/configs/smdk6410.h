...
#define CONFIG_SERVERIP		192.168.1.178
...
#define CONFIG_BOOTARGS    	"setenv bootargs noinitrd mem=224M console=ttySAC0 init=/init ubi.mtd=1 root=ubi0:rootfs rootfstype=ubifs"
#define CONFIG_ETHADDR		00:22:12:34:56:90
#define CONFIG_NETMASK          255.255.255.0
#define CONFIG_IPADDR		192.168.1.20
#define CONFIG_SERVERIP		192.168.1.178
...
#define CONFIG_BOOTCOMMAND	"nand read c0008000 40000 300000;bootm c0008000"
#elif defined(CONFIG_BOOT_MOVINAND)
#define CFG_ENV_IS_IN_MOVINAND
#define CFG_NAND_HWECC
#define CONFIG_BOOTCOMMAND	 "nand read c0008000 40000 300000;bootm c0008000"
//"movi read zImage c0008000;bootm c0008000"
