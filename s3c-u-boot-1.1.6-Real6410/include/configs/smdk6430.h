 ...
 * (easy to change)
 */
#define CONFIG_S3C6430		1		/* in a SAMSUNG S3C6430 SoC */
...
#define virt_to_phys(x)	virt_to_phy_smdk6430(x)
#else
...
#define CFG_PROMPT		"SMDK6430 # "	/* Monitor Command Prompt	*/
...
#define CONFIG_IDENT_STRING	" for SMDK6430"
